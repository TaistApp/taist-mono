...
<head>
	...
	<title>Taist - Terms and Conditions</title>
</head>
<body style="font-family: arial; color: #000;">
	...
	<ul>
		...
		<li>
			<p><strong>Company</strong> (referred to as either &quot;the Company&quot;, &quot;We&quot;, &quot;Us&quot;
				or &quot;Our&quot; in this Agreement) refers to Taist, Inc., Fishers, IN 46038.</p>
		</li>
		<li>
		...
		<li>
			<p><strong>Website</strong> refers to Taist, accessible from <a href="https://www.taist.app" rel="external nofollow noopener" target="_blank">http://www.taist.app</a></p>
		</li>
		<li>
	...
	<p>Cooking recommendation: To avoid potential fire and burning of individuals and children, any cooking method that
		involves flambeau cooking should not be conducted.</p>
	<p>Customer Participation: It is recommended that no individual, other than the hired chef, be involved in the
		cooking process. It is mandatory that no one under the age of 18 be involved in the cooking process.</p>
	...
	<p>We reserve the right to refuse or cancel Your Order at any time for certain reasons including but not limited to:
	</p>
	<ul>
	...
	<p>Any Goods you purchase can only be returned in accordance with these Terms and Conditions and Our Returns Policy.
	</p>
	...
	<p>Your right to cancel an Order only applies to Goods that are returned in the same condition as You received them.
		You should also include all of the product's instructions, documents and wrappings. Goods that are damaged or
		not in the same condition as You received them or which are worn simply beyond opening the original packaging
		will not be refunded. You should therefore take reasonable care of the purchased Goods while they are in Your
		possession.</p>
	...
	<ul>
		...
		<li>The supply of digital content which is not supplied on a tangible medium if the performance has begun with
			Your prior express consent and You have acknowledged Your loss of cancellation right.</li>
	</ul>
	...
	<p>By posting Content to the Service, You grant Us the right and license to use, modify, publicly perform, publicly
		...
		other users of the Service, who may also use Your Content subject to these Terms.</p>
	...
	<p>The Company is not responsible for the content of the Service's users. You expressly understand and agree that
		You are solely responsible for the Content and for all activity that occurs under Your account, whether done so
		by You or any third person using Your account.</p>
	...
	<ul>
		...
		<li>Defamatory, discriminatory, or mean-spirited content, including references or commentary about religion,
			race, sexual orientation, gender, national/ethnic origin, or other targeted groups.</li>
		...
		<li>Infringing on any proprietary rights of any party, including patent, trademark, trade secret, copyright,
			right of publicity or other rights.</li>
	...
	<p>The Company reserves the right, but not the obligation, to, in its sole discretion, determine whether or not any
		Content is appropriate and complies with these Terms, refuse or remove this Content. The Company further
		reserves the right to make formatting and edits and change the manner of any Content. The Company can also limit
		or revoke the use of the Service if You post such objectionable Content.
		As the Company cannot control all content posted by users and/or third parties on the Service, you agree to use
		the Service at your own risk. You understand that by using the Service You may be exposed to content that You
		may find offensive, indecent, incorrect or objectionable, and You agree that under no circumstances will the
		Company be liable in any way for any content, including any errors or omissions in any content, or any loss or
		damage of any kind incurred as a result of your use of any content.</p>
	<h3>Content Backups</h3>
	<p>Although regular backups of Content are performed, the Company does not guarantee there will be no loss or
	...
	<p>The Company will provide support and attempt to troubleshoot any known or discovered issues that may affect the
		...
		the failure to successfully restore Content to a usable state.</p>
	...
	<p>If You are a copyright owner, or authorized on behalf of one, and You believe that the copyrighted work has been
		...
		submit Your notice in writing to the attention of our copyright agent via email at <a href="mailto:contact@taist.app">contact@taist.app</a> and include in Your notice a
	...
	<p>You can contact our copyright agent via email at <a href="mailto:contact@taist.app">contact@taist.app</a>.
	...
	<p>You assign all rights, title and interest in any Feedback You provide the Company. If for any reason such
		...
		worldwide right and license to use, reproduce, disclose, sub-license, distribute, modify and exploit such
		Feedback without restriction.</p>
	...
	<ul>
		<li>By email: <a href="mailto:contact@taist.app">contact@taist.app</a></li>
	</ul>
</body>
</html>