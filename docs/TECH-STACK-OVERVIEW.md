...
| Expo / EAS        | contact@taist.app                       | Owner of org `taistapp`. ⚠️ NOT a.daynearnett@gmail.com (that's the BluBranch login — no access; switch with `eas login` before Taist builds) |
